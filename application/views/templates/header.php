...
<body style="background-size:cover; background-image: url(<?php echo base_url('images/background.jpg');?>">
	...
	<div class="col-xs-1 col-sm-2 col-md-2 col-lg-2"></div>
			<div class="container col-xs-10 col-sm-8 col-md-8 col-lg-6" style="background-color: white; margin-top:10px; margin-bottom:10px; margin-right:10px; margin-left:10px;">
				<div class="row">
					<div class="box01">
						<div class="login-window" style="margin-top:10px; margin-bottom:10px; margin-right:10px; margin-left:10px;">
							<div class="page-header" style="background-color: #B4EEB4;">
								<br>
							  <center><h1>Student Profiles 4 </h1></center>
								</br>
							</div>
